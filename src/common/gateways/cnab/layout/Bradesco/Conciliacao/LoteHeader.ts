...
export type LoteHeaderConciliacao = {
  banco: string;
  lote: string;
  registro: string;
  operacao: string;
  ...
  empresa_nome: string;
  data_inicial: string;
  valor_saldo_inicial?: string;
  situacao_saldo_inicial?: string;
  status?: string;
  tipo_moeda: string;
  sequencia_extrato?: string;
};

export const fieldsLoteHeaderConciliacao: FieldConfig<
  keyof LoteHeaderConciliacao
>[] = [
  {
    id: "G001",
    field: "banco",
