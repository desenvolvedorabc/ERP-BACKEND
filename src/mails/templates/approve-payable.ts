export const ApprovePayableTemplate = ({
  identifierCode,
  password,
  link,
}: {
  ...
  return `
    ...
    <div style='background: #FFFFFF; border-radius: 10px; padding: 14px;'>
      <p
          ...
          Acesse a conta a pagar de número ${identifierCode} para aprovação
      </p>
      ...
      <center style='margin-top: 30px;'><a href="${link}"
          style='margin-top: 30px; width:250px; height: 50px; background: #32C6F4;border-radius: 6px; color: #000000; text-decoration: none; font-family: Arial; padding: 10px 20px;'>Acessar conta</a></center>
      </p>
    </div>
  </center>
