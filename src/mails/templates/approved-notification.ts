export const ApprovedNotificationTemplate = ({
  identifierCode,
  link,
}: {
  ...
  <center>
    ...
    <div style='background: #FFFFFF; border-radius: 5px; padding: 14px;'>
      <p style='color: #7C7C7C; font-size: 14px; font-family: Arial, Helvetica, sans-serif; padding:8px; margin:8px;'>Olá, sua conta de número ${identifierCode} foi aprovada.</p>
